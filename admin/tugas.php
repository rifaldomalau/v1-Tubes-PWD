                ...
                <div>
                    ...
                    <div>
                        <form method="POST">
                            ...
                            <button type="submit" name="simpan_tugas">Kirim Tugas</button>
                        </form>
                    </div>
                </div>
            </div>
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="tugas-edit.php?id=<?php echo $row['id']; ?>">Edit</a>
                                        <a href="tugas.php?hapus=<?php echo $row['id']; ?>" 
                                ...
                                <?php 
                                    ...
                                    echo "<tr><td colspan='4'>Belum ada tugas.</td></tr>";
                                }
                                ?>
                            </tbody>
                        </table>
